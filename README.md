...
<p>Driven and versatile IT professional with a background in software engineering and full-stack development, specializing in JavaScript and Python. Recently earned the CompTIA Security+ certification and am actively pursuing the Network+ certification to expand expertise in IT security and network infrastructure. Proficient in building responsive web applications, managing databases, and integrating RESTful APIs, I am now focused on roles such as SOC Analyst, Help Desk Technician, and IT Support Specialist. Recognized for strong communication, customer service excellence, problem-solving abilities, and time management, I thrive in dynamic environments and bring a collaborative and detail-oriented approach to every task. With a commitment to continuous learning and a passion for technology, I am eager to contribute my skills to safeguarding systems, resolving technical challenges, and driving operational success in a forward-thinking organization.
</p>

- 🔭 I’m currently working on getting my Network+ & CySA+
